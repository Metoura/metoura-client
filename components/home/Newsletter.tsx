...
const Newsletter: NextPage = () => {
    return (
        <div className='relative flex flex-col w-full px-4 md:px-24'>
            <div className=' newsletter-bg h-[180px] md:h-[269px] items-between'>
                <div className='my-9 mx-12 md:my-14 md:mx-32'>
